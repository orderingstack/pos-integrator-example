...
function createDatabase(dbFileName = DB_FILENAME_DEFAULT) {
    ...
    const result = db.exec(migration);
    //if (result) console.log('Local db structures OK.');
}
...
// TODO: nie usuwac gdy nie sa przeprocesowane (ew. zamkniete)  atrybuty: closed, completed, status, processed
